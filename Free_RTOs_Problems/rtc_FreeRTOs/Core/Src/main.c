...
osThreadId set_timeHandle;
osThreadId get_timeHandle;
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN Header_set_time_rtc */
/**
  * @brief  Function implementing the set_time thread.
...
/* USER CODE BEGIN Header_get_time_rtc */
/**
* @brief Function implementing the get_time thread.
* @param argument: Not used
* @retval None
*/
