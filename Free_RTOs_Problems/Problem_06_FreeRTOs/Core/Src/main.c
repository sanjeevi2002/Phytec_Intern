...
void sw1_led3(void const * argument);
...
int main(void)
{
  ...
  /* Create the thread(s) */
  /* definition and creation of on_led */
  osThreadDef(on_led, sw1_led3, osPriorityNormal, 0, 128);
  on_ledHandle = osThreadCreate(osThread(on_led), NULL);
...
/* USER CODE BEGIN Header_sw1_led3 */
/**
  * @brief  Function implementing the on_led thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_sw1_led3 */
void sw1_led3(void const * argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
